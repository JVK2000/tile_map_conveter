...
tile_data_for_mapping_gd35 = [
    0, 0, 0, 1, 17, 0, 2, 19, 0, 3, 14, 0, 4, 15, 0, 5, 18, 0, 6, 1, 0, 7, 1, 1, 8, 1, 2, 9, 1, 3, 10, 11, 0, 11, 21,
    0, 12, 16, 0, 13, 13, 0, 65542, 1, 65536, 65543, 1, 65537, 65544, 1, 65538, 65545, 1, 65539, 65546, 11, 65536,
    65547, 21, 1, 65549, 13, 65536, 131078, 1, 131072, 131079, 1, 131073, 131080, 1, 131074, 131081, 1, 131075, 131082,
    11, 131072, 131083, 21, 2, 131085, 13, 131072, 196614, 1, 196608, 196615, 1, 196609, 196616, 1, 196610, 196617, 1,
    196611, 196619, 21, 3
]
...
project_dir = os.path.join(home_dir, "git/test_1")
